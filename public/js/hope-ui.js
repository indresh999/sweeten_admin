...
(function () {
 ...
 //setting offcanvas active button
document.addEventListener('DOMContentLoaded', function () {
    const darkModeBtn = document.getElementById('darkModeBtn');
    const darkModeBtn2 = document.getElementById('darkModeBtn1');
    const autoBtn = document.getElementById('darkModeBtn2');
    const htmlElement = document.documentElement;

    function updateButtonStates() {
        darkModeBtn.classList.remove('active');
        darkModeBtn2.classList.remove('active');
        autoBtn.classList.remove('active');

        if (darkModeBtn.getAttribute('data-value') === 'dark' &&
            htmlElement.getAttribute('data-bs-theme') === 'dark') {
            darkModeBtn.classList.add('active');
        } else if (darkModeBtn2.getAttribute('data-value') === 'light' &&
                   htmlElement.getAttribute('data-bs-theme') === 'light') {
            darkModeBtn2.classList.add('active');
        }
    }
