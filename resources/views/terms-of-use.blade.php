                ...
                <div class="accordion-item">
                    ...
                    <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                        ...
                        <div class="accordion-body">
                            ...
                            <code>non cupidatat skateboard dolor brunch.</code> Food truck quinoa nesciunt laborum eiusmod
                        </div>
                    </div>
                </div>
                <div class="accordion-item">
                    ...
                    <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree"
                        ...
                        <div class="accordion-body">
                            <strong>Anim pariatur cliche reprehenderit,</strong> enim eiusmod high life accusamus terry
                            richardson ad squid. <code> 3 wolf moon officia aute,</code> non cupidatat skateboard dolor
                            brunch.
                        </div>
                    </div>
                </div>
                <div class="accordion-item">
                    ...
                    <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour"
                        ...
                        <div class="accordion-body">
                            ...
                            aute,<code> non cupidatat skateboard dolor brunch.</code> Food truck quinoa nesciunt laborum
                            eiusmod.
                        </div>
                    </div>
                </div>
                    ...
                    <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive"
                        ...
                        <div class="accordion-body">
                            <strong>Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad
                                squid.</strong> 3 wolf moon officia
                            aute,<code> non cupidatat skateboard dolor brunch.</code> Food truck quinoa nesciunt laborum
                            eiusmod.
                        </div>
                    </div>
