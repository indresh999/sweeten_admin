<x-app-layout layout="dualcompact" :assets="$assets ?? []">
   <div class="row">
               ...
               <div class="card" data-aos="fade-up" data-aos-delay="900">
                  ...
                  <div class="card-body">
                     <div class="flex-wrap d-flex align-items-center justify-content-between">
                        ...
                        <div class="d-grid gap-2 col-md-4 col-lg-4">
                           <div class="d-flex align-items-start">
                              <svg class="mt-2 icon-14" xmlns="http://www.w3.org/2000/svg" width="14" viewBox="0 0 24 24" fill="#93C572">
                                 <g>
                                    <circle cx="12" cy="12" r="8" fill="#93C572"></circle>
                                 </g>
                              </svg>
                              <div class="ms-3">
                        ...
                        <table id="basic-table" class="table mb-0 table-striped" role="grid">
                           ...
                           <tbody>
                              <tr>
                                 <td>
                                    <div class="d-flex align-items-center">
                                       <img class="rounded bg-primary-subtle img-fluid avatar-40 me-3" src="{{asset('images/shapes/01.png')}}" alt="profile">
                              ...
                              <tr>
                                 <td>
                                    <div class="d-flex align-items-center">
                                       <img class="rounded bg-primary-subtle img-fluid avatar-40 me-3" src="{{asset('images/shapes/05.png')}}" alt="profile">
                              ...
                              <tr>
                                 <td>
                                    <div class="d-flex align-items-center">
                                       <img class="rounded bg-primary-subtle img-fluid avatar-40 me-3" src="{{asset('images/shapes/02.png')}}" alt="profile">
                              ...
                              <tr>
                                 <td>
                                    <div class="d-flex align-items-center">
                                       <img class="rounded bg-primary-subtle img-fluid avatar-40 me-3" src="{{asset('images/shapes/03.png')}}" alt="profile">
                              ...
                              <tr>
                                 <td>
                                    <div class="d-flex align-items-center">
                                       <img class="rounded bg-primary-subtle img-fluid avatar-40 me-3" src="{{asset('images/shapes/04.png')}}" alt="profile">
            ...
            <div class="col-md-12 col-lg-12">
               <div class="card credit-card-widget" data-aos="fade-up" data-aos-delay="900">
                  ...
                  <div class="card-body">
                     ...
                     <div class="grid-cols-2 d-grid gap-2 gap-md-4">
