<nav class="nav navbar navbar-expand-xl navbar-light iq-navbar">
  <div class="container-fluid navbar-inner">
    ...
    <div class="col-lg-2 col-lg-3 navbar-brand navbar-horizontal-brand">
      <a href="{{route('dashboard')}}" class="navbar-brand navbar-horizontal-brand">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="sub-drop dropdown-menu dropdown-menu-end p-0" aria-labelledby="notification-drop">
            <div class="card shadow-none m-0">
              <div class="card-header d-flex justify-content-between bg-primary py-3    rounded-top">
              ...
              <div class="card-body p-0">
                <a href="#" class="iq-sub-card">
                  <div class="d-flex align-items-center">
                      ...
                      <div class="ms-3 w-100">
                        <h6 class="mb-0 iq-text ">Emma Watson Bni</h6>
                ...
                <a href="#" class="iq-sub-card">
                  <div class="d-flex align-items-center">
                      ...
                      <div class="ms-3 w-100">
                        <h6 class="mb-0 iq-text  ">New customer is join</h6>
                        <div class="d-flex justify-content-between align-items-center">
                ...
                <a href="#" class="iq-sub-card">
                  <div class="d-flex align-items-center">
                      ...
                      <div class="ms-3 w-100">
                        <h6 class="mb-0 iq-text ">Two customer is left</h6>
                        <div class="d-flex justify-content-between align-items-center">
                            <p class="mb-0">Cyst Bni</p>
                ...
                <a href="#" class="iq-sub-card">
                  <div class="d-flex align-items-center">
                      ...
                      <div class="w-100 ms-3">
                        <h6 class="mb-0 iq-text  ">New Mail from Fenny</h6>
                        <div class="d-flex justify-content-between align-items-center">
                            <p class="mb-0">Cyst Bni</p>
