<ul class="navbar-nav iq-main-menu" id="sidebar">
    ...
    <li class="nav-item">
        <a class="nav-link " data-bs-toggle="collapse" href="#sidebar-app-user" role="button" aria-expanded="false"
            aria-controls="sidebar-app-user">
            <i class="icon">
                <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                        d="M11.9488 14.54C8.49884 14.54 5.58789 15.1038 5.58789 17.2795C5.58789 19.4562 8.51765 20.0001 11.9488 20.0001C15.3988 20.0001 18.3098 19.4364 18.3098 17.2606C18.3098 15.084 15.38 14.54 11.9488 14.54Z"
        ...
        <ul class="sub-nav collapse" id="sidebar-app-user" data-bs-parent="#sidebar">
            ...
            <li class="nav-item">
                <a class="nav-link {{activeRoute(route('users.index'))}}" href="{{route('users.index')}}">
                    ...
                    <i class="sidenav-mini-icon"> U </i>
                    <span class="item-name">All App Users</span>
                </a>
            </li>
        </ul>
    </li>
