                            ...
                            <div class="d-flex flex-column text-center align-items-center justify-content-between ">
                                ...
                                <div class="d-flex icon-pill">
                                    <a href="#" class="btn btn-sm rounded-pill px-2 py-2 ms-2">
                                        <svg class="icon-20" xmlns="http://www.w3.org/2000/svg" class="text-primary"
                                    ...
                                    <a href="#" class="btn btn-sm rounded-pill px-2 py-2  ms-2">
                                        <svg class="icon-20" xmlns="http://www.w3.org/2000/svg" class="text-danger"
                                            width="20" viewBox="0 0 20 20" fill="currentColor">
                                            <path
                                    ...
                                    <a href="#" class="btn btn-sm rounded-pill px-2 py-2 ms-2">
                                        <svg class="icon-20" xmlns="http://www.w3.org/2000/svg" class="text-success"
                                            width="20" viewBox="0 0 20 20" fill="currentColor">
                                            <path fill-rule="evenodd"
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <div class="d-flex align-items-center">
                                <a href="#" class=" border rounded">
                                    <svg class="icon-28" width="28" viewBox="0 0 24 24" fill="none"
                        ...
                        <div class="d-flex  justify-content-start align-items-center mb-3">
                            <div class="pe-3">
                                <img src="{{asset('/images/avatars/02.png')}}"
                                    class="rounded-circle p-1 bg-danger-subtle" width="60" height="60" alt="1">
                            </div>
                            <div>
            ...
            <div class="col-lg-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-start align-items-center">
                            <div class="pe-3">
                                <img src="{{asset('/images/avatars/03.png')}}"
                                    class="rounded-circle bg-primary-subtle p-1" width="50" height="50" alt="1">
                            </div>
                            <div>
                        ...
                        <div class="d-flex justify-content-start align-items-center mt-4">
                            <div class="pe-3">
                                <img src="{{asset('/images/avatars/04.png')}}"
                                    class="rounded-circle bg-danger-subtle p-1" width="50" height="50" alt="1">
                            </div>
                            <div>
                        ...
                        <div class="d-flex justify-content-start align-items-center mt-4">
                            <div class="pe-3">
                                <img src="{{asset('/images/avatars/05.png')}}" class="rounded-circle bg-info-subtle p-1"
                        ...
                        <div class="comment-area mt-3">
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="like-block position-relative d-flex align-items-center">
                                    <div class="d-flex align-items-center">
                                        <p class="mb-0">
                                            <svg class="icon-18" width="18" class="me-1" viewBox="0 0 24 24">
                                                <path fill="currentColor"
                                                    d="M5,9V21H1V9H5M9,21A2,2 0 0,1 7,19V9C7,8.45 7.22,7.95 7.59,7.59L14.17,1L15.23,2.06C15.5,2.33 15.67,2.7 15.67,3.11L15.64,3.43L14.69,8H21C22.11,8 23,8.9 23,10V12C23,12.26 22.95,12.5 22.86,12.73L19.84,19.78C19.54,20.5 18.83,21 18,21H9M9,19H18.03L21,12V10H12.21L13.34,4.68L9,9.03V19Z" />
                                            </svg>
                                            140 Likes
                                        </p>
                                        <p class="ms-2 ms-md-3 mb-0">comments</p>
                                    </div>
                                </div>
                                ...
                                <a href="javascript:void(0);"
                                    ...
                                    <span class="btn-inner">
                                        <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg" currentColor="#93C572">
