            ...
            <div class="row">
                ...
                <div class="star-box mt-4">
                    <div class="d-flex mb-2  align-items-center">
                        ...
                        <img src="{{ asset('images/landing-pages/images/home-1/13.webp')}}" alt="02"
        ...
        <div class="container">
            ...
            <div class="row row-cols-sm-2 row-cols-lg-4">
                <div class="col">
                    <div class="card services-box  rounded-1">
                        <div class="card-body p-0">
                            <h5 class="mb-3">400+ UI Components</h5>
                ...
                <div class="col">
                    <div class="card services-box  rounded-1">
                        <div class="card-body p-0">
                            <h5 class="mb-3">Universal UI Toolkit</h5>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. </p>
                            <svg width="12" height="13" viewBox="0 0 12 13" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <h2 class="text-secondary  text-capitalize heading-title">What they say <br> <span
                    ...
                    <a hrer="javascript" class="btn btn-primary mt-3">Get Started</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <p class="title-text">It is a long established fact that a reader will be distracted by the readable
                    ...
                    <img src="{{asset('images/landing-pages/images/home-1/playstore.webp') }}" alt="04" class="img-fluid">
                    <img src="{{asset('images/landing-pages/images/home-1/appstore.webp') }}" alt="05" class="img-fluid ms-3">
                </div>
                <div class="star-box mt-4">
                    <div class="d-flex mb-2  align-items-center">
                        <div class="border-end pe-2">
                ...
                <div class="col-lg-7 mt-5 mt-lg-0">
                    ...
                    <img src="{{ asset('images/landing-pages/images/home-1/dwn-1.webp') }}" alt="07" class="img-fluid d-block mx-auto">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="inner-box  overflow-hidden">
        ...
        <div class="row align-items-center justify-content-center ">
            <div class="col-lg-2 col-md-6">
                <img src="{{asset('images/landing-pages/images/home-1/01.webp')}}" alt="10"
                    class="img-fluid d-block mx-auto">
            </div>
             <div class="col-lg-2 col-md-6">
                <img src="{{asset('images/landing-pages/images/home-1/02.webp')}}" alt="11"
                    class="img-fluid d-block mx-auto">
             </div>
            <div class="col-lg-3 col-md-12">
                <img src="{{asset('images/landing-pages/images/home-1/03.webp')}}" alt="12"
                class="img-fluid d-block mx-auto">
            </div>
            <div class="col-lg-2 col-md-6">
                <img src="{{asset('images/landing-pages/images/home-1/15.webp')}}" alt="13"
                    class="img-fluid d-block mx-auto">
            </div>
            <div class="col-lg-2 col-md-6">
                <img src="{{asset('images/landing-pages/images/home-1/16.webp')}}" alt="14"
                class="img-fluid d-block mx-auto">
            </div>
        </div>
    ...
    <div class="section-padding bg-body">
        ...
        <div class="row">
            ...
            <div class="row align-items-center text-center row-cols-2 row-cols-sm-2 row-cols-md-2 row-cols-lg-4 mt-4">
                <div class="ol mb-lg-0 mb-4 border-end">
