<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="landing-pages" data-bs-theme-color="theme-color-default">
...
<body class=" body-bg landing-pages" data-bs-spy="scroll" data-bs-target="#elements-section" data-bs-offset="0" tabindex="0">
    <div id="loading">
        {{-- @if ($isHeader1)
    ...
    <a class="btn btn-fixed-end btn-primary btn-icon btn-landing" href="{{route('dashboard')}}">Dashboard Demo</a>
