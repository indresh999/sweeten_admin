<x-app-layout layout="simple" :assets="$assets ?? []">
        ...
        <div class="main-img">
            <div class="container">
                ...
                <div class="d-block d-md-flex justify-content-center align-items-center">
                    <div>
                        <a class="bg-white text-black btn  mb-1 mb-md-0 d-md-flex" target="_blank" href="{{ route('dashboard') }}">
                            <svg width="22" height="22" class="me-1" xmlns="http://www.w3.org/2000/svg" fill="none"
                    ...
                    <div class="ms-0 ms-md-3">
                        <a class="bg-white btn  text-black d-md-flex" target="_blank"
                    ...
                    <div class="collapse navbar-collapse" id="navbar-2">
                        <ul class="navbar-nav ms-auto mb-2 mb-lg-0 d-flex align-items-start">
                            ...
                            <li class="nav-item me-3 mb-2 mb-lg-0">
                                <a class="btn btn-secondary d-flex align-items-center" aria-current="page"
                                    href="/landing-pages/index" target="_blank">
                                    Landing pages
                                </a>
                            </li>
                            <li class="nav-item me-3 mb-2 mb-lg-0">
    ...
    <div class=" body-class-1 container">
        <aside
            class="mobile-offcanvas bd-aside card iq-document-card sticky-xl-top text-muted align-self-start mb-5 "
            id="left-side-bar">
            ...
            <nav class="small" id="elements-section">
                <ul class="list-unstyled mb-0 elem-list" >
                    <li class="mt-2">
                        <button class="btn d-inline-flex align-items-center ms-2 collapsed" data-bs-toggle="collapse"
                        ...
                        <ul class="list-unstyled ps-3 collapse" id="components-collapse" href="#components" style="">
                            ...
                            <li><a class="nav-link d-inline-flex align-items-center rounded" href="#buttons">Buttons</a>
                            </li>
                            <li><a class="nav-link d-inline-flex align-items-center rounded" href="#button-group">Button
                                    Group</a></li>
                            <li><a class="nav-link d-inline-flex align-items-center rounded"
                    ...
                    <li class="mb-2">
                        ...
                        <ul class="list-unstyled ps-3 collapse" id="contents-collapse" href="#content" style="">
                            ...
                            <li><a class="nav-link d-inline-flex align-items-center rounded" href="#figures">Figures</a>
                            </li>
                        </ul>
                    </li>
                </ul>
                ...
                <article id="accordion">
                    ...
                    <div class="card iq-document-card iq-doc-head">
                        <div class="d-flex justify-content-end">
                            <ul class="nav nav-tabs nav-tunnel nav-slider  p-1" data-toggle="slider-tab" role="tablist">
...
&#x3C;/div&#x3E;</code></pre>
                ...
                <article id="alerts">
                    ...
                    <div class="card iq-document-card">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane bd-heading-1 fade show active" id="content-alert-prv" role="tabpanel"
                                aria-labelledby="typo-output">
                                <div class="bd-example">
...
&#x3C;/div&#x3E;</code></pre>
                ...
                <article id="badge">
                    ...
                    <div class="card iq-document-card">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane bd-heading-1 fade show active" id="content-badge-prv" role="tabpanel"
                                aria-labelledby="typo-output">
                                <div class="bd-example">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane bd-heading-1 fade show active" id="content-Button-prv" role="tabpanel"
                                ...
                                <div class="bd-example">
                                    ...
                                    <button type="button" class="btn btn-dark text-white">Dark</button>
                                ...
                                <div class="bd-example">
                                    ...
                                    <button type="button" class="btn btn-outline-dark hover-dark">Dark</button>
                                ...
                                <div class="bd-example">
                                   ...
                                   <button type="button" class="btn btn-dark-subtle text-white">Dark</button>
                                   <button type="button" class="btn btn-gray-subtle">Gray</button>
                               </div>
                            </div>
                            ...
                            <div class="tab-pane bd-heading-1 fade show active" id="content-Calendar-prv"
                                ...
                                <div class="row">
                                    <div class="col-md-6 order-md-1">
                                        ...
                                        <div class="bd-example">
                                            <div class="form-group">
                                                <input type="text" name="start" class="form-control range_flatpicker"
                                        ...
                                        <div class="bd-example">
                                            <div class="form-group">
                                                <div class="input-group wrap_flatpicker">
                                                    ...
                                                    <a class="input-group-text input-button" title="clear" data-clear
                                                ...
                                                <div class="row g-0">
                                                    <div class="col-md-4">
                                                        <svg class="bd-placeholder-img" width="100%" height="250"
                                                            ...
                                                            </rect><text x="50%" y="50%" fill="#dee2e6"
                                                                dy=".3em" text-anchor="middle">Image</text>
                                                        </svg>
                ...
                <article id="carousel">
                    ...
                    <div class="card iq-document-card">
                        ...
                        <div class="tab-content">
                                        ...
                                        <div class="carousel-inner">
                                            <div class="carousel-item">
                                                <svg class="bd-placeholder-img bd-placeholder-img-lg d-block w-100"
                                                    ...
                                                    <text x="50%" y="50%" fill="#555" dy=".3em" text-anchor="middle">First slide</text>
                                                </svg>
                                            ...
                                            <div class="carousel-item active">
                                                <svg class="bd-placeholder-img bd-placeholder-img-lg d-block w-100"
                                                    ...
                                                    <text x="50%" y="50%" fill="#444" dy=".3em" text-anchor="middle">Second slide</text>
                                                </svg>
                                            ...
                                            <div class="carousel-item">
                                                <svg class="bd-placeholder-img bd-placeholder-img-lg d-block w-100"
                                                    ...
                                                    <text x="50%" y="50%" fill="#333" dy=".3em" text-anchor="middle">Third slide</text>
                                                </svg>
                            ...
                            <div class="tab-pane bd-heading-1 fade show" id="content-Carousel-code" role="tabpanel"
                                aria-labelledby="typo-output">
                                <div class="section-block">
                                    <pre><code class="language-markup"> &#x3C;div class=&#x22;bd-example&#x22;&#x3E;
    &#x3C;div id=&#x22;carouselExampleCaptions&#x22; class=&#x22;carousel slide&#x22; data-bs-ride=&#x22;carousel&#x22;&#x3E;
                    ...
                    <div class="card iq-document-card">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link d-flex align-items-center" data-bs-toggle="tab"
                                        ...
                                        <svg width="20" class="me-1" viewBox="0 0 24 24" fill="none"
                                            ...
                                            <path
                                                d="M17 14.5945L17.7769 15.2241L18.2871 14.5945L17.7769 13.9649L17 14.5945ZM15f.0057 17.0556L14.2288 16.426L14.2288 16.426L15.0057 17.0556ZM14.4981 17.103L15.1488 16.3437L15.1488 16.3437L14.4981 17.103ZM14.452 16.581L13.675 15.9515L13.675 15.9515L14.452 16.581ZM16.0617 14.5945L16.8387 15.2241L17.3488 14.5945L16.8387 13.9649L16.0617 14.5945ZM14.452 12.6079L13.675 13.2375L13.675 13.2375L14.452 12.6079ZM14.4981 12.0859L15.1488 12.8452L15.1488 12.8452L14.4981 12.0859ZM15.0057 12.1334L15.7826 11.5038L15.7826 11.5038L15.0057 12.1334ZM13.8474 17.8624C14.4316 18.363 15.3039 18.276 15.7826 17.6852L14.2288 16.426C14.4527 16.1497 14.8704 16.1052 15.1488 16.3437L13.8474 17.8624ZM13.675 15.9515C13.2095 16.5259 13.2798 17.3759 13.8474 17.8624L15.1488 16.3437C15.4106 16.5681 15.4396 16.9507 15.2289 17.2106L13.675 15.9515ZM15.2848 13.9649L13.675 15.9515L15.2289 17.2106L16.8387 15.2241L15.2848 13.9649ZM13.675 13.2375L15.2848 15.2241L16.8387 13.9649L15.2289 11.9784L13.675 13.2375ZM13.8474 11.3266C13.2798 11.813 13.2095 12.663 13.675 13.2375L15.2289 11.9784C15.4396 12.2383 15.4106 12.6209 15.1488 12.8452L13.8474 11.3266ZM15.7826 11.5038C15.3039 10.9129 14.4316 10.8259 13.8474 11.3266L15.1488 12.8452C14.8704 13.0838 14.4527 13.0393 14.2288 12.7629L15.7826 11.5038ZM15.7826 17.6852L17.7769 15.2241L16.2231 13.9649L14.2288 16.426L15.7826 17.6852ZM17.7769 13.9649L15.7826 11.5038L14.2288 12.7629L16.2231 15.2241L17.7769 13.9649Z"
                                                fill="currentColor" mask="url(#path-6-inside-2)" />
                                        </svg>
                                        Code
                                    </button>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane bd-heading-1 fade show active" id="content-dropdown-prv"
                                role="tabpanel" aria-labelledby="typo-output">
                                <div class="bd-example">
                                    <div class="btn-group w-100 align-items-center flex-wrap custom-rtl">
                                        <div class="dropdown">
                                            <button class="btn btn-gray btn-sm dropdown-toggle me-2 d-flex align-items-center gap-1 rtl-direction" type="button"
                                        ...
                                        <div class="dropdown">
                                            <button class="btn btn-gray dropdown-toggle me-2 d-flex align-items-center gap-1 rtl-direction" type="button"
                                        ...
                                        <div class="dropdown">
                                            <button class="btn btn-gray btn-lg dropdown-toggle me-2 d-flex align-items-center gap-1 rtl-direction" type="button"
                                ...
                                <div class="bd-example">
                                    <div class="flex-wrap btn-group w-100 align-items-center custom-rtl">
                                        <div class="dropend">
                            ...
                            <div class="tab-pane bd-heading-1 fade show active" id="content-listgroup-prv"
                                ...
                                <div class="bg-example">
                                    <div class="list-group">
                                        ...
                                        <a href="#" class="list-group-item list-group-item-action disabled"
                                            tabindex="-1">A disabled link item</a>
                                    </div>
                                </div>
                                ...
                                <div class="bd-example">
                                    <div class="list-group">
                                        ...
                                        <a href="#"
                                            class="list-group-item list-group-item-action list-group-item-light list-hover">A
                                        ...
                                        <a href="#"
                                            class="list-group-item list-group-item-action list-group-item-gray">A simple
                                            Gray list group item</a>
                                    </div>
                                </div>
    ...
    &#x3C;/div&#x3E;</code></pre>
                ...
                <article id="navbar">
                    ...
                    <div class="card iq-document-card">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane bd-heading-1 fade show active" id="content-Navbar-prv" role="tabpanel"
                                aria-labelledby="typo-output">
                                <div class="bd-example">
                                            ...
                                            <div class="collapse navbar-collapse" id="navbar-1">
                                                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                                                    ...
                                                    <li class="nav-item dropdown">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-end iq-drop"
    ...
    &#x3C;/div&#x3E;</code></pre>
                ...
                <article id="off-canvas">
                    ...
                    <div class="card iq-document-card">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane bd-heading-1 fade show active" id="content-Offcanvas-prv" role="tabpanel">
                                <div class="bd-example">
                            ...
                            <div class="tab-pane bd-heading-1 fade show" id="content-Offcanvas-code" role="tabpanel"
                                aria-labelledby="typo-output">
                                <div class="section-block">
                                    <pre><code class="language-markup"> &#x3C;div class=&#x22;bd-example&#x22;&#x3E;
                ...
                <article id="pagination">
                    ...
                    <div class="card iq-document-card">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane bd-heading-1 fade show" id="content-Pagination-code" role="tabpanel"
                                aria-labelledby="typo-output">
                                <div class="section-block">
                                    <pre><code class="language-markup"> &#x3C;div class=&#x22;bd-example&#x22;&#x3E;
        &#x3C;nav aria-label=&#x22;Pagination example&#x22;&#x3E;
    ...
    &#x3C;/div&#x3E;</code></pre>
                ...
                <article id="popovers">
                    ...
                    <div class="card iq-document-card">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane bd-heading-1 fade show active" id="content-Popover-prv" role="tabpanel"
                                aria-labelledby="typo-output">
                                <div class="bd-example">
                                    <button type="button" class="btn btn-danger" data-bs-toggle="popover" title=""
                ...
                <article id="progress">
                    ...
                    <div class="card iq-document-card">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane bd-heading-1 fade show" id="content-progress-code" role="tabpanel"
                                aria-labelledby="typo-output">
                                <div class="section-block">
                                    <pre><code class="language-markup">&#x3C;div class=&#x22;bd-example&#x22;&#x3E;
        &#x3C;div class=&#x22;progress mb-3&#x22;&#x3E;
                ...
                <article id="scrollspy">
                    ...
                    <div class="card iq-document-card">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane bd-heading-1 fade show" id="content-Scrollspy-code" role="tabpanel"
                                aria-labelledby="typo-output">
                                <div class="section-block">
                                    <pre><code class="language-markup">&#x3C;div class=&#x22;bd-example&#x22;&#x3E;
        &#x3C;nav id=&#x22;navbar-example2&#x22; class=&#x22;navbar navbar-light bg-light px-3&#x22;&#x3E;
                    ...
                    <div class="card iq-document-card">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane bd-heading-1 fade show active" id="content-Spinners-prv"
                                ...
                                <div class="bd-example">
                                    <button class="btn btn-primary mb-1 mb-md-0" type="button" disabled>
                            ...
                            <div class="tab-pane bd-heading-1 fade show" id="content-Spinners-code" role="tabpanel"
                                aria-labelledby="typo-output">
                                <div class="section-block">
                                    <pre><code class="language-markup">&#x3C;div class=&#x22;bd-example&#x22;&#x3E;
        &#x3C;div class=&#x22;spinner-border text-primary&#x22; role=&#x22;status&#x22;&#x3E;
    ...
    &#x3C;/div&#x3E;</code></pre>
                ...
                <article id="toasts">
                    ...
                    <div class="card iq-document-card">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane bd-heading-1 fade show active" id="content-Toasts-prv" role="tabpanel">
                                <div class="p-5 bd-example bg-dark align-items-center">
                                    <div class="toast fade show" role="alert" aria-live="assertive" aria-atomic="true">
                                        <div class="toast-header">
                                            <svg class="rounded bd-placeholder-img me-2 icon-20" width="20" height="20"
                                    ...
                                    <div class="toast fade show" role="alert" aria-live="assertive" aria-atomic="true">
                                        <div class="toast-body">
                                            ...
                                            <div class="pt-2 mt-2 border-top">
                                                <button type="button" class="btn btn-primary mb-1 mb-md-0">Take action</button>
                ...
                <article id="tooltips">
                    ...
                    <div class="card iq-document-card">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane bd-heading-1 fade show" id="content-Tooltips-code" role="tabpanel"
                                aria-labelledby="typo-output">
                                <div class="section-block">
                ...
                <article id="disabled-forms">
                    ...
                    <div class="card iq-document-card">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane bd-heading-1 fade show" id="content-disabled-code" role="tabpanel"
                                aria-labelledby="typo-output">
                                <div class="section-block">
                                    <pre><code class="language-markup">&#x3C;div class=&#x22;bd-example&#x22;&#x3E;
        &#x3C;form&#x3E;
    ...
    &#x3C;/div&#x3E;</code></pre>
                ...
                <article id="sizing">
                    ...
                    <div class="card iq-document-card">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane bd-heading-1 fade show active" id="content-sizing-prv" role="tabpanel"
                                aria-labelledby="typo-output">
                                <div class="bd-example">
                                    <div class="mb-3">
                ...
                <article id="input-group">
                    ...
                    <div class="card iq-document-card">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane bd-heading-1 fade show" id="content-inputgroup-code" role="tabpanel"
                                aria-labelledby="typo-output">
                                <div class="section-block">
                                    <pre><code class="language-markup">&#x3C;div class=&#x22;bd-example&#x22;&#x3E;
        &#x3C;div class=&#x22;input-group mb-3&#x22;&#x3E;
                ...
                <article id="a-form-control">
                    ...
                    <div class="card iq-document-card">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane bd-heading-1 fade show active" id="content-alternet-prv"
                                ...
                                <div class="bd-example">
                                    ...
                                    <div class="form-group input-group form-group-alt">
                                        <span class="input-group-text basic-new" id="basic-addon1">@</span>
                                        <input type="text" class="form-control" placeholder="Addon"
                                            aria-label="Username" aria-describedby="basic-addon1">
                                    </div>
                                    <div class="form-group input-group form-group-alt">
                                        <input type="text" class="form-control basic-new" placeholder="Addon"
                                            aria-label="Recipient's username" aria-describedby="basic-addon2">
                                        <span class="input-group-text  basic-new1" id="basic-addon2">@</span>
                                    </div>
                                    <div class="form-group form-group-alt">
                            ...
                            <div class="tab-pane bd-heading-1 fade show" id="content-alternet-code" role="tabpanel"
                                aria-labelledby="typo-output">
                                <div class="section-block">
                                    <pre><code class="language-markup"> &#x3C;div class=&#x22;bd-example&#x22;&#x3E;
        &#x3C;div class=&#x22;form-group form-group-alt&#x22;&#x3E;
                ...
                <article id="floating-labels">
                    ...
                    <div class="card iq-document-card">
                        ...
                        <div class="tab-content">
                                ...
                                <div class="bd-example">
                                    <form>
                                        <div class="form-floating mb-3">
                                            ...
                                            <label for="floatingInput" class="iq-form-input2">Email address</label>
                                        </div>
                                        <div class="form-floating mb-3">
                                            <input type="password" class="form-control" id="floatingPassword"
                                                placeholder="Password">
                                            <label for="floatingPassword" class="iq-form-input">Password</label>
                                        </div>
                                        <div class="form-floating form-group mb-3">
                                            <input type="email" class="form-control" disabled id="floatingInput"
                                                placeholder="Place Holder">
                                            <label for="floatingInput" class="iq-form-input">Regular</label>
                                        </div>
                                        <div class="form-floating form-group mb-3">
                            ...
                            <div class="tab-pane bd-heading-1 fade show" id="content-floating-code" role="tabpanel"
                                aria-labelledby="typo-output">
                                <div class="section-block">
                                    <pre><code class="language-markup"> &#x3C;div class=&#x22;bd-example&#x22;&#x3E;
        &#x3C;form&#x3E;
                ...
                <article id="a-floating-labels">
                    ...
                    <div class="card iq-document-card">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane bd-heading-1 fade show active" id="content-alternetfloat-prv"
                                ...
                                <div class="bd-example">
                                    <div
                                        ...
                                        <input type="email" class="form-control" id="floatingInput"
                                            placeholder="Place Holder">
                                        <label for="floatingInput" class="iq-form-input">Small</label>
                                    </div>
                                    ...
                                    <div
                                        ...
                                        <input type="email" class="form-control" id="floatingInput"
                                            placeholder="Place Holder">
                                        <label for="floatingInput" class="iq-form-input">Large</label>
                                    </div>
                                    <div class="form-floating custom-form-floating form-group mb-3">
                                        <input type="email" class="form-control" disabled id="floatingInput"
                                            placeholder="Place Holder">
                            ...
                            <div class="tab-pane bd-heading-1 fade show" id="content-alternetfloat-code" role="tabpanel"
                                aria-labelledby="typo-output">
                                <div class="section-block">
                                    <pre><code class="language-markup">&#x3C;div class=&#x22;bd-example&#x22;&#x3E;
    ...
    &#x3C;/div&#x3E;</code></pre>
                ...
                <article id="toggle-btn">
                    ...
                    <div class="card iq-document-card">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane bd-heading-1 fade show active" id="content-toggle-prv" role="tabpanel"
                                aria-labelledby="typo-output">
                                <div class="bd-example">
                                ...
                                <div class="bd-example">
                                    ...
                                    <div class="form-check form-switch form-check-inline pe-0">
                                        <input class="form-check-input form-check-inline" type="checkbox" id="switch4"
                                            checked disabled />
                ...
                <article id="validation">
                    ...
                    <div class="card iq-document-card">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane bd-heading-1 fade show" id="content-validation-code" role="tabpanel"
                                aria-labelledby="typo-output">
                                <div class="section-block">
                                    <pre><code class="language-markup">&#x3C;div class=&#x22;bd-example&#x22;&#x3E;
        &#x3C;form class=&#x22;row g-3&#x22;&#x3E;
            ...
            <section id="content">
                ...
                <article id="typography">
                    ...
                    <div class="card iq-document-card iq-doc-head">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane bd-heading-1 fade show active" id="content-typo-op" role="tabpanel"
                                aria-labelledby="typo-output">
                                <div class="bd-example">
    ...
    &#x3C;/div&#x3E;</code></pre>
                ...
                <article id="images">
                    ...
                    <div class="card iq-document-card">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane bd-heading-1 fade show active" id="content-image-prv" role="tabpanel"
                                aria-labelledby="typo-output">
                                <div class="bd-example">
                                    <svg class="bd-placeholder-img bd-placeholder-img-lg img-fluid" width="100%"
                                        ...
                                        <rect width="100%" height="100%" fill="#868e96"></rect><text x="50%" y="50%"
                                            fill="#dee2e6" dy=".3em" text-anchor="middle">Responsive image</text>
                                    </svg>
                                </div>
                                <div class="bd-example">
                                    <svg class="bd-placeholder-img img-thumbnail" width="200" height="200"
                                        ...
                                        <rect width="100%" height="100%" fill="#868e96"></rect><text x="50%" y="50%"
                                            fill="#dee2e6" dy=".3em" text-anchor="middle">200x200</text>
                                    </svg>
                                </div>
                            </div>
    ...
    &#x3C;/div&#x3E;</code></pre>
                ...
                <article id="tables">
                    ...
                    <div class="card iq-document-card">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane bd-heading-1 fade show active" id="content-table-prv" role="tabpanel"
                                aria-labelledby="typo-output">
                            ...
                            <ul class="nav nav-tabs nav-tunnel nav-slider  p-1" data-toggle="slider-tab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active d-flex align-items-center" data-bs-toggle="tab"
                                        ...
                                        aria-controls="output" aria-selected="true">
                                        <svg width="20" class="me-1 icon-20" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M22.4541 11.3918C22.7819 11.7385 22.7819 12.2615 22.4541 12.6082C21.0124 14.1335 16.8768 18 12 18C7.12317 18 2.98759 14.1335 1.54586 12.6082C1.21811 12.2615 1.21811 11.7385 1.54586 11.3918C2.98759 9.86647 7.12317 6 12 6C16.8768 6 21.0124 9.86647 22.4541 11.3918Z"
                                ...
                                <div class="bd-example">
                                    <figure class="figure">
                                        <svg class="bd-placeholder-img figure-img img-fluid rounded" width="400"
                                            ...
                                            <title>Placeholder</title>
                                            <rect width="100%" height="100%" fill="#868e96"></rect><text x="50%" y="50%"
                                                fill="#dee2e6" dy=".3em" text-anchor="middle">400x300</text>
                                        </svg>
