   ...
   <div class="row">
         ...
         <div class="card-body">
            <div class="d-grid gap-card grid-cols-3">
               <a data-fslightbox="gallery" href="{{asset('images/icons/04.png')}}">
                  <img src="{{asset('images/icons/04.png')}}" class="img-fluid bg-info-subtle rounded" alt="profile-image">
               </a>
               <a data-fslightbox="gallery" href="{{asset('images/shapes/02.png')}}">
                  <img src="{{asset('images/shapes/02.png')}}" class="img-fluid bg-primary-subtle rounded" alt="profile-image">
               </a>
               <a data-fslightbox="gallery" href="{{asset('images/icons/08.png')}}">
                  <img src="{{asset('images/icons/08.png')}}" class="img-fluid bg-info-subtle rounded" alt="profile-image">
               </a>
               <a data-fslightbox="gallery" href="{{asset('images/shapes/04.png')}}">
                  <img src="{{asset('images/shapes/04.png')}}" class="img-fluid bg-primary-subtle rounded" alt="profile-image">
               </a>
               <a data-fslightbox="gallery" href="{{asset('images/icons/02.png')}}">
                  <img src="{{asset('images/icons/02.png')}}" class="img-fluid bg-warning-subtle rounded" alt="profile-image">
               </a>
               <a data-fslightbox="gallery" href="{{asset('images/shapes/06.png')}}">
                  <img src="{{asset('images/shapes/06.png')}}" class="img-fluid bg-primary-subtle rounded" alt="profile-image">
               </a>
               <a data-fslightbox="gallery" href="{{asset('images/icons/05.png')}}">
                  <img src="{{asset('images/icons/05.png')}}" class="img-fluid bg-danger-subtle rounded" alt="profile-image">
               </a>
               <a data-fslightbox="gallery" href="{{asset('images/shapes/04.png')}}">
                  <img src="{{asset('images/shapes/04.png')}}" class="img-fluid bg-primary-subtle rounded" alt="profile-image">
               </a>
               <a data-fslightbox="gallery" href="{{asset('images/icons/01.png')}}">
                  <img src="{{asset('images/icons/01.png')}}" class="img-fluid bg-success-subtle rounded" alt="profile-image">
               </a>
            </div>
         </div>
         </div>
         ...
         <div class="card-body">
            <div class="twit-feed">
               <div class="d-flex align-items-center mb-2">
                  <img class="rounded-pill img-fluid avatar-50 me-3 p-1 bg-danger-subtle ps-2" src="{{asset('images/icons/03.png')}}" alt="">
            ...
            <div class="twit-feed">
               <div class="d-flex align-items-center mb-2">
                  <img class="rounded-pill img-fluid avatar-50 me-3 p-1 bg-primary-subtle" src="{{asset('images/icons/04.png')}}" alt="">
                  <div class="media-support-info">
            ...
            <div class="twit-feed">
               <div class="d-flex align-items-center mb-2">
                     <img class="rounded-pill img-fluid avatar-50 me-3 p-1 bg-warning-subtle pt-2" src="{{asset('images/icons/02.png')}}" alt="">
                  <div class="mt-2">
                  ...
                  <div class="header-title">
                     <div class="d-flex flex-wrap">
                        <div class="media-support-user-img me-3">
                           <img class="rounded-pill img-fluid avatar-60 bg-danger-subtle p-1 ps-2" src="{{asset('images/avatars/02.png')}}" alt="">
                        </div>
               ...
               <div class="card-body p-0">
                  ...
                  <div class="comment-area p-3">
                     ...
                     <ul class="list-inline p-0 m-0">
                        <li class="mb-2">
                           <div class="d-flex">
                              <img src="{{asset('images/avatars/03.png')}}" alt="userimg" class="avatar-50 p-1 pt-2 bg-primary-subtle rounded-pill img-fluid">
                              <div class="ms-3">
                        ...
                        <li>
                           <div class="d-flex">
                              <img src="{{asset('images/avatars/04.png')}}" alt="userimg" class="avatar-50 p-1 bg-danger-subtle rounded-pill img-fluid">
                              <div class="ms-3">
            ...
            <div class="card">
               <div class="card-header d-flex align-items-center justify-content-between pb-4">
                  <div class="header-title">
                     <div class="d-flex flex-wrap">
                        <div class="media-support-user-img me-3">
                           <img class="rounded-pill img-fluid avatar-60 p-1 bg-info-subtle" src="{{asset('images/avatars/05.png')}}" alt="">
                        </div>
                        <div class="media-support-info mt-2">
      ...
      <div class="col-lg-3">
         ...
         <div class="card-body">
            <ul class="list-inline m-0 p-0">
               <li class="d-flex mb-4 align-items-center active">
                  <img src="{{asset('images/icons/06.png')}}" alt="story-img" class="rounded-pill avatar-70 p-1 profile-story-img border  bg-light-subtle img-fluid">
                  <div class="ms-3">
                     <h5>Web Design</h5>
               ...
               <li class="d-flex mb-4 align-items-center">
                  <img src="{{asset('images/icons/03.png')}}" alt="story-img" class="rounded-pill avatar-70 p-1 border img-fluid bg-danger-subtle">
                  <div class="ms-3">
                     <h5>App Design</h5>
               ...
               <li class="d-flex align-items-center">
                  <img src="{{asset('images/icons/07.png')}}" alt="story-img" class="rounded-pill avatar-70 p-1 border bg-primary-subtle img-fluid">
                  <div class="ms-3">
         ...
         <div class="card-body">
            <ul class="list-inline m-0 p-0">
               <li class="d-flex mb-4 align-items-center">
                  <div class="img-fluid bg-warning-subtle rounded-pill"><img src="{{asset('images/icons/05.png')}}" alt="story-img" class="rounded-pill avatar-40"></div>
                  <div class="ms-3 flex-grow-1">
                     <h6>Paul Molive</h6>
                  ...
                  <a href="javascript:void(0);" class="btn btn-outline-primary rounded-circle btn-icon btn-sm p-2">
                     <span class="btn-inner">
                        <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" currentColor="#93C572">
               ...
               <li class="d-flex mb-4 align-items-center">
                  <div class="img-fluid bg-danger-subtle rounded-pill"><img src="{{asset('images/icons/03.png')}}" alt="story-img" class="rounded-pill avatar-40"></div>
                  <div class="ms-3 flex-grow-1">
                     <h6>Robert Fox</h6>
                     <p class="mb-0">4 mutual friends</p>
                  </div>
               ...
               <li class="d-flex mb-4 align-items-center">
                  <div class="img-fluid bg-dark-subtle rounded-pill"><img src="{{asset('images/icons/06.png')}}" alt="story-img" class="rounded-pill avatar-40"></div>
                  <div class="ms-3 flex-grow-1">
                     <h6>Jenny Wilson</h6>
               ...
               <li class="d-flex mb-4 align-items-center">
                  <div class="img-fluid bg-primary-subtle rounded-pill"><img src="{{asset('images/icons/07.png')}}" alt="story-img" class="rounded-pill avatar-40"></div>
                  <div class="ms-3 flex-grow-1">
                     <h6>Cody Fisher</h6>
               ...
               <li class="d-flex mb-4 align-items-center">
                  <div class="img-fluid bg-info-subtle rounded-pill"><img src="{{asset('images/icons/04.png')}}" alt="story-img" class="rounded-pill avatar-40"></div>
                  <div class="ms-3 flex-grow-1">
                     <h6>Bessie Cooper</h6>
               ...
               <li class="d-flex mb-4 align-items-center">
                  <div class="img-fluid bg-warning-subtle rounded-pill"><img src="{{asset('images/icons/02.png')}}" alt="story-img" class="rounded-pill avatar-40"></div>
                  <div class="ms-3 flex-grow-1">
                     <h6>Wade Warren</h6>
               ...
               <li class="d-flex mb-4 align-items-center">
                  <div class="img-fluid bg-success-subtle rounded-pill"><img src="{{asset('images/icons/01.png')}}" alt="story-img" class="rounded-pill avatar-40"></div>
                  <div class="ms-3 flex-grow-1">
                     <h6>Guy Hawkins</h6>
               ...
               <li class="d-flex align-items-center">
                  <div class="img-fluid bg-info-subtle rounded-pill"><img src="{{asset('images/icons/08.png')}}" alt="story-img" class="rounded-pill avatar-40"></div>
                  <div class="ms-3 flex-grow-1">
                     <h6>Floyd Miles</h6>
